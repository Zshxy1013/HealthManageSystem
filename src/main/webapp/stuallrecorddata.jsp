									...
									<header class="major">
										<h1>学生打卡记录</h1>
													...
													<ul class="pagination">
														...
														<li><a href="sturecordpage?curPage=${PageUtils.prePage}" class="button small">Prev</a></li>
														</c:if>
														<c:if test="${PageUtils.currentPage == 1}">
														<li><a href="sturecordpage?curPage=1" class="button small disabled">Prev</a></li>
														</c:if>
															...
															<c:if test="${PageUtils.currentPage+5<=PageUtils.totalPages}">
																<c:forEach var="i" begin="${PageUtils.currentPage-4}" end="${PageUtils.currentPage+5}">
																	...
																	<c:if test="${PageUtils.currentPage==i}">
																		<a class="page active" href="sturecordpage?curPage=${i}">${i}</a>
																	</c:if>
																	<c:if test="${PageUtils.currentPage!=i}">
																		<a class="page" href="sturecordpage?curPage=${i}">${i}</a>
																	</c:if>																
																	</li>
																</c:forEach>
															</c:if>
														...
														<li><a href="sturecordpage?curPage=${PageUtils.nextPage}" class="button small">Next</a></li>
														</c:if>
														<c:if test="${PageUtils.currentPage == PageUtils.totalPages}">
														<li><a href="sturecordpage?curPage=${PageUtils.totalPages}" class="button small disabled">Next</a></li>
														</c:if>
													</ul>
													</div>
												</section>
